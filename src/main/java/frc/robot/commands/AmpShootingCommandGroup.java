...
public class AmpShootingCommandGroup extends SequentialCommandGroup {
  ...
  public AmpShootingCommandGroup(Intake intake, Shoooter shooter) {
    ...
    addCommands(new ParallelDeadlineGroup(new WaitCommand(3), new ParallelCommandGroup(new ShootingCommand(shooter),new SequentialCommandGroup(new WaitCommand(2), new EjectNote(intake)))));
  }
}
